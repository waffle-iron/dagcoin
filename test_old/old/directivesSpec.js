...
describe('Unit: Testing Directives', () => {
  ...
  describe('Validate Address', () => {
    ...
    it('should validate with network', inject(($rootScope) => {
  ...
  describe('Password strength', () => {
    ...
    it('should check very weak password', () => {
      $scope.password = 'asd';
      $scope.$digest();
  ...
  describe('Match Password Inputs', () => {
    beforeEach(inject(($compile, $rootScope) => {
      $scope = $rootScope;
